...
import com.example.musify.data.Constants.NOTIFICATION_CHANNEL_ID
import com.example.musify.data.Constants.NOTIFICATION_ID
...
class MusicNotificationManager(
    ...
    private inner class DescriptionAdapter(
        ...
        override fun getCurrentContentTitle(player: Player): CharSequence {
            newSongCallback()
            return mediaController.metadata.description.title.toString() //media item in firebase music source
        }
